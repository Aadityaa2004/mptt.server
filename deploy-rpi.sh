...
echo -e "1. Set up SSL certificates: ./setup-ssl.sh"
echo -e "2. Start Nginx reverse proxy: $DOCKER_COMPOSE -f docker-compose.nginx.yml up -d"
echo -e "3. Verify deployment: https://orpheus-networks.com"
